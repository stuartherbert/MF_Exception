...
__mf_init_tests("MF/Exception");

class EnterpriseExceptionTest extends \PHPUnit_Framework_TestCase
{
        /**
         *
        ...
        {
                $this->fixture = new EnterpriseException(500, 1, 'param 1: %s, param 2: %s', array ('array 1', 'array 2'));
                $this->type    = 'EnterpriseException';
                $this->file    = basename(__FILE__);
                $this->line    = __LINE__ - 3;

                $rootCause = new \Test_Exception_RootCause();
                $this->fixtureWithRootCause = new EnterpriseException(500, 0, 'param 1: %s, param 2: %s', array ('array 1', 'array 2'), $rootCause);

                $symptom = new \Test_Exception_Symptom();
                $this->fixtureWithSymptom = new EnterpriseException(500, 0, 'param 1: %s, param 2: %s', array ('array 1', 'array 2'), $symptom);
        }
        ...
        {
                $this->assertEquals(500, $this->fixture->getHttpCode());
        }
